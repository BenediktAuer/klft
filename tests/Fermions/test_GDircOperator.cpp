...
int main(int argc, char* argv[]) {
  ...
  //     //       v(i0, i1, i2, i3) = gamma5 * v(i0, i1, i2, i3);
  //     //     });
  //     // deviceSpinorField<3, 4> Mu = apply_D<4, 3, 4>(u, gauge, gammas,
  //     -0.5);
  //     // deviceSpinorField<3, 4> Mv = apply_D<4, 3, 4>(v, gauge, gammas,
  //     -0.5);
  ...
  //     // Dont know if this function is needed again, therefore only defined
  //     here,
  //     // and not in an include file.
  //     printf("Apply Gauge Trafos...\n");
  //     KTune::parallel_for(
  //         "Gauge Trafo",
  //         Policy<4>(IndexArray<4>{0, 0, 0, 0}, IndexArray<4>{L0, L1, L2,
  //         L3}), KOKKOS_LAMBDA(const index_t i0, const index_t i1, const
  //         index_t i2,
  //                       const index_t i3) {
  // #pragma unroll
  ...
  //           }
  //           // Transform spinor u, and Mu
  //           u(i0, i1, i2, i3) = gaugeTrafo(i0, i1, i2, i3, 1) * u(i0, i1, i2,
  //           i3); Mu(i0, i1, i2, i3) =
  ...
  //     Kokkos::Random_XorShift64_Pool<> random_pool(/*seed=*/1234);
  //     deviceSpinorField<2, 4> u_SU2(L0, L1, L2, L3, random_pool, 0, 1.0
  //     / 1.41); deviceSpinorField<2, 4> v_SU2(L0, L1, L2, L3, random_pool,
  //     0, 1.0 / 1.41); real_t norm_SU2 = spinor_norm_sq<4, 2, 4>(u_SU2);
  ...
  //     real_t r3_SU2 =
  //         Kokkos::sqrt(r_SU2.real() * r_SU2.real() + r_SU2.imag() *
  //         r_SU2.imag());
  //     r3_SU2 /= norm_SU2;
  ...
  //                                         Kokkos::Array<int, 4>{i0, i1, i2,
  //                                         i3}, mu, 1, IndexArray<4>{L0, L1,
  //                                         L2, L3}),
  //                                     1));
  //           }
  //           // Transform spinor u, and Mu
  ...
  //     Kokkos::Random_XorShift64_Pool<> random_pool(/*seed=*/1234);
  //     deviceSpinorField<1, 4> u_U1(L0, L1, L2, L3, random_pool, 0, 1.0
  //     / 1.41); deviceSpinorField<1, 4> v_U1(L0, L1, L2, L3, random_pool,
  //     0, 1.0 / 1.41); real_t norm_U1 = spinor_norm_sq<4, 1, 4>(u_U1); norm_U1
  //     *= spinor_norm_sq<4, 1, 4>(v_U1); norm_U1 = Kokkos::sqrt(norm_U1);
  ...
  //     real_t r3_U1 =
  //         Kokkos::sqrt(r_U1.real() * r_U1.real() + r_U1.imag() *
  //         r_U1.imag());
  //     r3_U1 /= norm_U1;
